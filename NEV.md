...
├── src/
│   ├── apikeys.ts          # Centralized API Keys configuration
│   ├── components/         # Reusable UI components
│   │   ├── AIGeneratedImage.tsx # Component for AI-generated images
│   │   └── ui/             # shadcn/ui and other base components
│   ├── pages/              # Main application pages
│   │   ├── Dashboard.tsx   # Main dispatch and fleet tracking dashboard
│   │   ├── LandingPage.tsx # Application entry point and marketing page
│   │   ├── Login.tsx       # Authentication page
│   │   ├── Profile.tsx     # User profile and settings
│   │   ├── SOS.tsx         # Public SOS mode for immediate emergency requests
│   │   └── SafeRoute.tsx   # Safe routing, hazard mapping, and POI search
│   ├── App.tsx             # Main application router and layout wrapper
│   ├── main.tsx            # React entry point
│   └── index.css           # Global Tailwind CSS styles
├── server.ts               # Express backend server (if applicable)
...
*Note: The project uses a centralized `src/apikeys.ts` file to manage these keys across both the frontend and backend.*

## 🧭 Application Navigation & Data Flow

### 1. Landing Page (`src/pages/LandingPage.tsx`)
*   **Purpose:** The main entry point showcasing core capabilities.
*   **Navigation:** Routes users to the Dashboard (Login), Public SOS Mode, or Safe Routing.
...
### 3. Safe Routing (`src/pages/SafeRoute.tsx`)
...
### 4. Public SOS (`src/pages/SOS.tsx`)
*   **Purpose:** A streamlined interface for the public to quickly request emergency assistance.

### 5. Profile & Login (`src/pages/Profile.tsx`, `src/pages/Login.tsx`)
*   **Purpose:** User authentication and preference management.
...
3. **Adding a new API Integration:** Update `src/apikeys.ts` with any new required keys, then create a new service file in `src/services/` to keep component files clean.
